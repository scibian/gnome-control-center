...
G_BEGIN_DECLS
/* enumerations from "/home/rmatos/Source/git.gnome.org/install/include/gsettings-desktop-schemas/gdesktop-enums.h" */
...
GType g_desktop_magnifier_focus_tracking_mode_get_type (void) G_GNUC_CONST;
#define G_DESKTOP_TYPE_DESKTOP_MAGNIFIER_FOCUS_TRACKING_MODE (g_desktop_magnifier_focus_tracking_mode_get_type())
GType g_desktop_magnifier_caret_tracking_mode_get_type (void) G_GNUC_CONST;
#define G_DESKTOP_TYPE_DESKTOP_MAGNIFIER_CARET_TRACKING_MODE (g_desktop_magnifier_caret_tracking_mode_get_type())
